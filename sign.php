...
if (!isset($_POST['name'], $_POST['password'], $_POST['email'], $_POST['mobile_number'])) {
    // Could not get the data that should have been sent.
    exit('Please complete the registration form!');
}
// Make sure the submitted registration values are not empty.
if (empty($_POST['name']) || empty($_POST['password']) || empty($_POST['email']) || empty($_POST['mobile_number'])) {
...
if ($stmt = $con->prepare('SELECT name, password FROM users WHERE email = ?')) {
